      ...
      <ScrollView>
        <View style={styles.content}>
          ...
          <View style={styles.contentWrapper}>
            <View style={styles.wrapImg1}>
              <View style={styles.imgFood1}>
                <Image source={Drink4} style={styles.food} />
              </View>
              <View style={styles.title1}>
                <Text style={styles.food1}>Red Velvet</Text>
                <Text style={styles.food2}>With Ice</Text>
                <View style={styles.contentWrapper}>
            ...
            <View style={styles.wrapImg1}>
              <View style={styles.imgFood1}>
                <Image source={Drink5} style={styles.food} />
              </View>
              <View style={styles.title1}>
                <Text style={styles.food1}>Esteh</Text>
                <Text style={styles.food2}>with Ice</Text>
                <View style={styles.contentWrapper}>
          ...
          <View style={styles.contentWrapper}>
            <View style={styles.wrapImg1}>
              <View style={styles.imgFood1}>
                <Image source={Drink6} style={styles.food} />
              </View>
              <View style={styles.title1}>
                <Text style={styles.food1}>Lemon</Text>
                <Text style={styles.food2}>With Ice</Text>
                <View style={styles.contentWrapper}>
                  <Text style={styles.food3}>$ 3</Text>
                  <TouchableOpacity
            ...
            <View style={styles.wrapImg1}>
              <View style={styles.imgFood1}>
                <Image source={Drink7} style={styles.food} />
              </View>
              <View style={styles.title1}>
                <Text style={styles.food1}>Sprite</Text>
                <Text style={styles.food2}>With Ice</Text>
                <View style={styles.contentWrapper}>
                  <Text style={styles.food3}>$ 5</Text>
                  <TouchableOpacity
          ...
          <View style={styles.contentWrapper}>
            <View style={styles.wrapImg1}>
              <View style={styles.imgFood1}>
                <Image source={Drink8} style={styles.food} />
              </View>
              <View style={styles.title1}>
                <Text style={styles.food1}>Brown Sugar</Text>
                <Text style={styles.food2}>With Ice</Text>
                <View style={styles.contentWrapper}>
                  <Text style={styles.food3}>$ 6</Text>
                  <TouchableOpacity
            ...
            <View style={styles.wrapImg1}>
              <View style={styles.imgFood1}>
                <Image source={Drink9} style={styles.food} />
              </View>
              <View style={styles.title1}>
                <Text style={styles.food1}>Coffe</Text>
                <Text style={styles.food2}>Hot</Text>
                <View style={styles.contentWrapper}>
                  <Text style={styles.food3}>$ 5</Text>
                  <TouchableOpacity
                    style={styles.button}
