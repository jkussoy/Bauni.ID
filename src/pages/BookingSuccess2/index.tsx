...
import {Backgroundd, Img2, Img4, SuperMario} from '../../assets/images';
import {Barcode, LogoWhite, Verif} from '../../assets/icon';

const BookingSuccess2 = ({navigation}) => {
  return (
    <View style={styles.container}>
      ...
      <View style={styles.bookingSuccessContainer}>
        ...
        <View style={styles.bookingDetailsContainer}>
          ...
          <Text style={styles.detailValue}>AIW31</Text>
        </View>
      </View>
      <View style={styles.orderSummaryContainer}>
        <Text style={styles.orderSummaryTitle}>Your Order Summary</Text>
        <View style={styles.movieDetailsContainer}>
          <Image source={SuperMario} style={styles.moviePoster} />
          <View style={styles.movieDetailsTextContainer}>
            <Text style={styles.title}>Movie Title</Text>
            <Text style={styles.movieTitle}>The Super Mario Bros Movie</Text>
            <View style={styles.date}>
              <Text style={styles.textDate}>Date: </Text>
              <Text style={styles.movieDate}>May 17th, 2023</Text>
            </View>
            <View style={styles.time}>
              <Text style={styles.textTime}>Time: </Text>
              <Text style={styles.movieTime}>19:00 PM</Text>
            </View>
...
export default BookingSuccess2;
