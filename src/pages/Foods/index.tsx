      ...
      <ScrollView>
        <View style={styles.content}>
          ...
          <View style={styles.contentWrapper}>
            <View style={styles.wrapImg1}>
              <View style={styles.imgFood1}>
                <Image source={Food2} style={styles.food} />
              </View>
              <View style={styles.title1}>
            ...
            <View style={styles.wrapImg1}>
              <View style={styles.imgFood1}>
                <Image source={Food3} style={styles.food} />
              </View>
              <View style={styles.title1}>
                <Text style={styles.food1}>Pop Corn</Text>
                <Text style={styles.food2}>with Caramel</Text>
                <View style={styles.contentWrapper}>
          ...
          <View style={styles.contentWrapper}>
            <View style={styles.wrapImg1}>
              <View style={styles.imgFood1}>
                <Image source={Food4} style={styles.food} />
              </View>
              <View style={styles.title1}>
                <Text style={styles.food1}>Potato</Text>
                <Text style={styles.food2}>Original</Text>
            ...
            <View style={styles.wrapImg1}>
              <View style={styles.imgFood1}>
                <Image source={Food5} style={styles.food} />
              </View>
              <View style={styles.title1}>
          ...
          <View style={styles.contentWrapper}>
            <View style={styles.wrapImg1}>
              <View style={styles.imgFood1}>
                <Image source={Food6} style={styles.food} />
              </View>
              <View style={styles.title1}>
                <Text style={styles.food1}>Burger</Text>
                <Text style={styles.food2}>Chicken</Text>
                <View style={styles.contentWrapper}>
                  <Text style={styles.food3}>$ 6</Text>
                  <TouchableOpacity
                    style={styles.button}
            ...
            <View style={styles.wrapImg1}>
              <View style={styles.imgFood1}>
                <Image source={Food7} style={styles.food} />
              </View>
              <View style={styles.title1}>
                <Text style={styles.food1}>Burger</Text>
                <Text style={styles.food2}>Double Beef</Text>
                <View style={styles.contentWrapper}>
                  <Text style={styles.food3}>$ 5</Text>
                  <TouchableOpacity
                    style={styles.button}
